# Human face target detection dataset 16000 images Yolo format electronic resource

# Body

Human Face Object Detection Dataset, 16000 Images, Yolo Format, Electronic Documentary

The image is rich in content, including various face scenes, suitable for target detection, facial recognition, computer vision related projects. The dataset is fully labeled and ready to use, saving time and effort

Purchased immediately and sent to the cloud storage link, for .
